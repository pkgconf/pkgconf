...
spdxtool_core_creation_info_new(pkgconf_client_t *client, char *agent_id, char *id)
{
	spdxtool_core_creation_info_t *creation_struct = calloc(1, sizeof(spdxtool_core_creation_info_t));
...
{
	spdxtool_core_spdx_document_t *spdx_struct = calloc(1, sizeof(spdxtool_core_spdx_document_t));
	(void)client;
